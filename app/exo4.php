    ...
    <div class="container">
        ...
        <section class="exercice">
            ...
            <div class="exercice-sandbox">
                <?php
                $school1 = new School('École de Catch de Moscou', '7 rue de l\'Ours, Moscou');
                $school2 = new School('Poudlard', 'Cachée quelque part en Angleterre près d\'un lac ou à peu près');
